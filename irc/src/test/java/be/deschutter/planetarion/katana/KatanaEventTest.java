...
//        KatanaEvent e = new KatanaEvent(messageEvent);
//
//        assertThat(e.getReturnType()).isEqualTo(ReturnTypeEnum.NOTICE);
//        assertThat(e.getCommand()).isEqualTo("test");
...
//        KatanaEvent e = new KatanaEvent(messageEvent);
//
//        assertThat(e.getReturnType()).isEqualTo(ReturnTypeEnum.PRIVATE_MSG);
//        assertThat(e.getCommand()).isEqualTo("test");
//        assertThat(e.getParameters()).isEqualTo("");
//    }
//
...
//        KatanaEvent e = new KatanaEvent(messageEvent);
//
//        assertThat(e.getReturnType()).isEqualTo(ReturnTypeEnum.CHANNEL_MSG);
//        assertThat(e.getCommand()).isEqualTo("test");
//        assertThat(e.getParameters()).isEqualTo("");
//    }
//
