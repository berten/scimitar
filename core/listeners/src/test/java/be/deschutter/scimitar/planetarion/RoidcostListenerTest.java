...
private PaConfig paConfig;
    ...
    public void getPattern() throws Exception {
        assertThat(roidcostListener.getPattern()).isEqualTo("roids value_cost <mining_bonus>");
    }

    @Test
    public void getResult_NoGovernmentStuffz() throws Exception {
        assertThat(roidcostListener.getResult("Berten","150", "65000", "30")).isEqualTo(
    ...
    public void getResult_NoGovernmentStuffz_ValueWithKilos() throws Exception {
        assertThat(roidcostListener.getResult("Berten","150", "65k", "30")).isEqualTo(
            "Capping 150 roids at 65k value with 30% bonus will repay in 134 ticks (6 days)");
    }

    @Test
    public void getResult_NoGovernmentStuffz_ValueWithKilos_NoBonus() throws Exception {
        assertThat(roidcostListener.getResult("Berten","150", "65k")).isEqualTo(
